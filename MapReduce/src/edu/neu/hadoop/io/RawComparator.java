...
/**
 * <p> A {@link Comparator} that operates directly on byte representations of
 * objects. </p>
 * @param <T>
...
public interface RawComparator<T> extends Comparator<T> {
	/**
	 * Compare two objects in binary. b1[s1:l1] is the first object, and
	 * b2[s2:l2] is the second object.
	 * 
